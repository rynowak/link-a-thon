...
namespace Microsoft.Extensions.DependencyInjectionInjection.ServiceLookup
{
    internal abstract class ServiceProviderEngine : IServiceProviderEngine, IServiceScopeFactory
    {
        ...
        protected ServiceProviderEngine(
            ...
            IEnumerable<KeyValuePair<Type, Func<ServiceProviderEngineScope, object>>> realizedServices = null)
        {
            ...
            {
                foreach (var (type, func) in realizedServices)
                {
                    RealizedServices[type] = func;
                }
            }
        }
